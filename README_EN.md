...
The AI calls **390+ CAD / Civil 3D methods** (the live list is whatever the plugin reflects) to do the actual work:
edit entities, draw geometry, build 3D solids, create surfaces / alignments / corridors / pipe networks, export quantities.
...
- The palette polls for replies every 2 s (an SSE endpoint exists but is not wired up yet)
