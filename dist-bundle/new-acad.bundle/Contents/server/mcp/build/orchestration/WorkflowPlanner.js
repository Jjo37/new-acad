function getObjectCounts(projectContext) {
    const drawingInfo = (projectContext.drawingInfo ?? {});
    return drawingInfo.objectCounts ?? {};
}
function findMissingFields(params, requiredFields) {
...
function buildFieldClarificationQuestions(fields) {
...
export function buildWorkflowPlan(routed, params, projectContext) {
