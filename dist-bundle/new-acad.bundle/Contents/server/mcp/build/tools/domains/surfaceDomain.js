...
export const SURFACE_DOMAIN_DEFINITION = {
    domain: "surface",
    actions: {
        list: {
            action: "list",
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSurfaces", {})),
        },
        get: {
            action: "get",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurface", {
                name: args.name,
            })),
        },
        get_elevation: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurfaceElevation", {
                name: args.name,
                x: args.x,
                y: args.y,
            })),
        ...
        get_elevation_along: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurfaceElevationsAlong", {
                name: args.name,
                points: args.points,
            })),
        },
        get_statistics: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurfaceStatistics", {
                name: args.name,
        ...
        create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSurface", {
                name: args.name,
                style: args.style,
                layer: args.layer,
        ...
        delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deleteSurface", {
                name: args.name,
            })),
        },
        add_points: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("addSurfacePoints", {
                name: args.name,
                points: args.points,
                description: args.description,
            })),
        ...
        add_breakline: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("addSurfaceBreakline", {
                name: args.name,
        ...
        add_boundary: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("addSurfaceBoundary", {
                name: args.name,
        ...
        extract_contours: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("extractSurfaceContours", {
                name: args.name,
        ...
        compute_volume: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("computeSurfaceVolume", {
        ...
        volume_calculate: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("calculateSurfaceVolume", {
                baseSurface: args.baseSurface,
                comparisonSurface: args.comparisonSurface,
        ...
        volume_report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurfaceVolumeReport", {
                baseSurface: args.baseSurface,
                comparisonSurface: args.comparisonSurface,
        ...
        volume_by_region: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("calculateSurfaceVolumeByRegion", {
                baseSurface: args.baseSurface,
                comparisonSurface: args.comparisonSurface,
        ...
        analyze_slope: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("analyzeSurfaceSlope", {
                name: args.name,
        ...
        analyze_elevation: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("analyzeSurfaceElevation", {
                name: args.name,
                ranges: args.ranges ?? null,
                numRanges: args.numRanges ?? 5,
            })),
        ...
        analyze_directions: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("analyzeSurfaceDirections", {
                name: args.name,
        ...
        watershed_add: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("addSurfaceWatershed", {
                name: args.name,
        ...
        contour_interval_set: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("setSurfaceContourInterval", {
                name: args.name,
                minorInterval: args.minorInterval,
                majorInterval: args.majorInterval,
            })),
        ...
        statistics_get: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurfaceStatisticsDetailed", {
                name: args.name,
            })),
        },
        sample_elevations: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("sampleSurfaceElevations", {
                name: args.name,
                method: args.method,
        ...
        create_from_dem: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSurfaceFromDem", {
        ...
        comparison_workflow: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => {
                const baseSurface = SurfaceDetailResponseSchema.parse(await appClient.sendCommand("getSurface", {
                    name: args.baseSurface,
                }));
                const comparisonSurface = SurfaceDetailResponseSchema.parse(await appClient.sendCommand("getSurface", {
                    name: args.comparisonSurface,
                }));
                const volumeAnalysis = SurfaceVolumeResponseSchema.parse(await appClient.sendCommand("computeSurfaceVolume", {
                    baseSurface: args.baseSurface,
                    comparisonSurface: args.comparisonSurface,
                }));
        ...
        drainage_workflow: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => {
                const surface = SurfaceDetailResponseSchema.parse(await appClient.sendCommand("getSurface", {
                    name: args.name,
                }));
                const flowPath = HydrologyFlowPathResponseSchema.parse(await appClient.sendCommand("traceHydrologyFlowPath", {
                ...
                const sampledElevations = SurfaceElevationAlongResponseSchema.parse(await appClient.sendCommand("getSurfaceElevationsAlong", {
                    name: args.name,
                ...
                const runoffEstimate = HydrologyRunoffResponseSchema.parse(await appClient.sendCommand("estimateHydrologyRunoff", {
    ...
    exposures: [
        {
            ...
            description: "曲面聚合工具：查询/读取/统计/分析/编辑/体积",
        ...
        },
        {
            ...
            description: "向曲面添加高程点 {name, points} 等",
            inputShape: {
        ...
        },
        {
            ...
            description: "从 DEM 创建曲面 {filePath}",
            inputShape: {
                filePath: z.string(),
                name: z.string(),
                style: z.string().optional(),
        ...
        },
        {
            ...
            description: "曲面比较向导（多步）{baseSurface, comparisonSurface}",
            inputShape: {
                baseSurface: z.string(),
                comparisonSurface: z.string(),
            },
        ...
        },
        {
            ...
            description: "曲面排水向导（多步）{surfaceName}",
            inputShape: {
                surfaceName: z.string(),
                x: z.number(),
                y: z.number(),
