...
export const SURVEY_DOMAIN_DEFINITION = {
    domain: "survey",
    actions: {
        database_list: {
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSurveyDatabases", {})),
        },
        database_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSurveyDatabase", {
                name: args.name,
                path: args.path ?? null,
            })),
        },
        figure_list: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSurveyFigures", {
        ...
        figure_get: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSurveyFigure", {
                name: args.name,
                databaseName: args.databaseName ?? null,
            })),
        },
        observation_list: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSurveyObservations", {
        ...
        network_adjust: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("adjustSurveyNetwork", {
                databaseName: args.databaseName,
        ...
        figure_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSurveyFigure", {
                databaseName: args.databaseName,
        ...
        landxml_import: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("importSurveyLandXml", {
