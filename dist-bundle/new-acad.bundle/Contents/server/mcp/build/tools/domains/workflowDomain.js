...
function buildWorkflowResult(workflow, summary, steps, outputs, warnings = []) {
    return {
        workflow,
...
export const WORKFLOW_DOMAIN_DEFINITION = {
    domain: "workflow",
    actions: {
        corridor_qc_report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("corridorQcReportWorkflow", {
        ...
        grading_surface_volume: {
            ...
            execute: async (args) => {
                ...
                return buildWorkflowResult("grading_surface_volume", `Calculated grading/earthwork volume between '${args.baseSurface}' and '${args.comparisonSurface}'.`, [
                    {
        ...
        surface_comparison_report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("surfaceComparisonReportWorkflow", {
                baseSurface: args.baseSurface,
                comparisonSurface: args.comparisonSurface,
                format: args.format,
            })),
        ...
        data_shortcut_publish_sync: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("dataShortcutPublishSyncWorkflow", {
        ...
        data_shortcut_reference_sync: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("dataShortcutReferenceSyncWorkflow", {
                projectFolder: args.projectFolder,
                shortcutName: args.shortcutName,
        ...
        project_startup: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("projectStartupWorkflow", {
        ...
        project_reference_setup: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("projectReferenceSetupWorkflow", {
        ...
        drawing_readiness_audit: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("drawingReadinessAuditWorkflow", {
        ...
        feature_line_to_grading: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("featureLineToGradingWorkflow", {
        ...
        pipe_network_design: {
            ...
            execute: async (args) => {
                ...
                return buildWorkflowResult("pipe_network_design", `Completed pipe-network sizing workflow for '${args.networkName}'.`, steps, {
                    sizing: sizingResult,
        ...
        plan_production_publish: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("planProductionPublishWorkflow", {
                outputPath: args.outputPath,
        ...
        qc_fix_and_verify: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcFixAndVerifyWorkflow", {
                layerPrefix: args.layerPrefix,
                checkLineweights: args.checkLineweights,
                checkColors: args.checkColors,
        ...
        survey_import_adjust_figures: {
            ...
            execute: async (args) => {
                ...
                const warnings = [];
                let observationsResult = null;
                let adjustmentResult = null;
                let figureCreateResult = null;
                if (args.networkName) {
                ...
                return buildWorkflowResult("survey_import_adjust_figures", `Completed survey import workflow for database '${args.databaseName}'.`, steps, {
                    import: importResult,
    ...
    exposures: [
        {
            ...
            description: "工作流聚合工具：多步向导（质检/土方/图纸生产等）",
        ...
        },
        {
            ...
            description: "曲面对比报告向导：对比两曲面并生成体积报告（多步）",
            inputShape: {
                baseSurface: z.string(),
                comparisonSurface: z.string(),
                format: WorkflowVolumeReportFormatSchema.optional(),
        ...
        },
        {
            ...
            description: "图纸生产发布向导：发布图纸集或指定布局为 PDF（多步）",
            inputShape: {
                outputPath: z.string(),
                sheetSetName: z.string().optional(),
                layoutNames: z.array(z.string()).optional(),
