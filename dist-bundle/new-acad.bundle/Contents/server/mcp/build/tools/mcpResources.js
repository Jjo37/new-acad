...
export function registerMcpResources(server) {
    server.registerResource("civil3d-tool-catalog", "civil3d://catalog/tools", {
        ...
        const defaultTools = MIGRATED_DOMAIN_DEFINITIONS.flatMap((definition) => selectManifestExposures(definition, includeAliases).map((exposure) => exposure.toolName));
        return {
            contents: [{
                    uri: uri.href,
                    mimeType: "application/json",
    ...
    server.registerResource("civil3d-safety-guidance", "civil3d://docs/safety-and-approval", {
    ...
    server.registerResource("civil3d-framework-standards", "civil3d://standards/framework", {
    ...
    server.registerResource("civil3d-generated-report", new ResourceTemplate("civil3d://reports/{reportId}", {
        list: async () => ({
