...
function pickDefined(params, fields) {
    return Object.fromEntries(fields
        .filter((field) => params[field] !== undefined)
        .map((field) => [field, params[field]]));
}
function buildActionArgs(action, fields = [], defaults = {}) {
    return (params) => ({
        action,
        ...defaults,
...
function buildPassthroughArgs(fields = [], defaults = {}) {
    return (params) => ({
        ...defaults,
        ...pickDefined(params, fields),
    });
}
const EXPLICIT_TOOL_CATALOG = [
    {
        intent: "drawing_info",
    ...
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["baseSurface", "comparisonSurface"], { method: "tin_volume" }),
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["baseSurface", "comparisonSurface"], { format: "summary" }),
    },
    {
    ...
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["name", "gridSpacing"], { method: "grid" }),
    },
    {
    ...
    },
    {
        ...
        buildToolArgs: buildActionArgs("create_from_surface", ["alignmentName", "profileName", "surfaceName", "style", "layer", "labelSet"]),
    },
    {
        ...
        buildToolArgs: buildActionArgs("create_layout", ["alignmentName", "profileName", "style", "layer", "labelSet"]),
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["designSpeed", "alignmentName", "profileName"], {
            speedUnits: "kmh",
    ...
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["alignmentName", "profileName", "designSpeed"], {
            stationInterval: 25,
            standard: "AASHTO",
        }),
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["inflow", "outflow", "surfaceName"], {
            stormDuration: 60,
    ...
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["surfaceName", "bottomElevation", "topElevation"], {
    ...
    },
    {
        ...
        buildToolArgs: buildPassthroughArgs(["alignmentName", "profileName", "surfaceName"], {
            cutSlopeRatio: 2.0,
            fillSlopeRatio: 3.0,
            benchWidth: 0,
...
function buildActionSynonyms(action) {
    switch (action) {
        case "list":
...
function inferDerivedRequiredFields(tool, operation) {
    const toolNameFieldMap = {
    ...
    if (tool.toolName === "civil3d_health" || tool.toolName === "civil3d_get_drawing_info") {
        return [];
    }
...
function buildDerivedTitle(tool, operation) {
    if (!operation) {
...
function buildDerivedKeywords(tool, operation) {
...
export const TOOL_CATALOG = [
    ...EXPLICIT_TOOL_CATALOG.map((entry) => ({ ...entry, source: "explicit" })),
    ...buildDerivedRouteEntries(),
];
export function findToolCatalogEntry(toolName, action) {
    if (action) {
