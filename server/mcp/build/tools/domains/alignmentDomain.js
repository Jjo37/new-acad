...
// 样式/标签集修改 schema (2026-08-16 道路建模能力补齐，2026-09-14 从 build 回移补回 src)
...
function buildStationSequence(startStation, endStation, interval, maximumSamples) {
    const stations = [];
    ...
    if (estimatedSamples > maximumSamples) {
        throw new Error(`Alignment report would require ${estimatedSamples} samples, which exceeds the maximum of ${maximumSamples}. ` +
...
export const ALIGNMENT_DOMAIN_DEFINITION = {
    domain: "alignment",
    actions: {
        list: {
            action: "list",
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listAlignments", {})),
        },
        get: {
            action: "get",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getAlignment", {
                name: args.name,
            })),
        },
        station_to_point: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentStationToPoint", {
                name: args.name,
        ...
        point_to_station: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentPointToStation", {
                name: args.name,
                x: args.x,
                y: args.y,
            })),
        ...
        create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createAlignment", {
                name: args.name,
                points: args.points,
                type: args.type,
                site: args.site,
        ...
        delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deleteAlignment", {
                name: args.name,
            })),
        },
        report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => {
                const alignment = AlignmentDetailResponseSchema.parse(await appClient.sendCommand("getAlignment", {
                    name: args.name,
                }));
                const interval = Number(args.interval ?? Math.max((alignment.endStation - alignment.startStation) / 20, 25));
                ...
                const stationSamples = AlignmentStationSamplesResponseSchema.parse(await appClient.sendCommand("alignmentSampleStations", {
                    name: args.name,
                    stations,
                    offset: args.offset ?? 0,
                })).samples;
                const entityTypeBreakdown = alignment.entities.reduce((accumulator, entity) => {
        ...
        add_tangent: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentAddTangent", {
        ...
        add_curve: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentAddCurve", {
                alignmentName: args.name,
        ...
        add_spiral: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentAddSpiral", {
                alignmentName: args.name,
        ...
        delete_entity: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentDeleteEntity", {
                alignmentName: args.name,
        ...
        set_station_equation: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentSetStationEquation", {
                alignmentName: args.name,
        ...
        get_station_offset: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentGetStationOffset", {
                alignmentName: args.name,
                x: args.x,
                y: args.y,
            })),
        ...
        offset_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentOffsetCreate", {
                alignmentName: args.name,
        ...
        widen_transition: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("alignmentWidenTransition", {
                alignmentName: args.name,
                side: args.side,
        ...
        set_style: {
            ...
            requiresActiveDrawing: true,
            safeForRetry: false,
            pluginMethods: ["setAlignmentStyle"],
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("setAlignmentStyle", {
    ...
    exposures: [
        {
            ...
            description: "路线聚合工具：查询/读取/桩号换算/创建/删除/编辑路线",
        ...
        },
        {
            ...
            description: "偏移路线 {alignmentName, offsetName, offset}",
            inputShape: {
                alignmentName: z.string(),
                offsetName: z.string(),
                offset: z.number(),
        ...
        },
        {
            ...
            description: "修改路线样式/标签集 {alignmentName, style?, labelSet?}——style 查 listStyles alignment，labelSet 查 listStyles alignmentlabelset",
            inputShape: {
                alignmentName: z.string(),
                style: z.string().optional(),
                labelSet: z.string().optional(),
