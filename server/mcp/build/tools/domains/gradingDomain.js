...
export const GRADING_DOMAIN_DEFINITION = {
    domain: "grading",
    actions: {
        group_list: {
            action: "group_list",
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listGradingGroups", {})),
        },
        group_get: {
            action: "group_get",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getGradingGroup", { name: args.name })),
        },
        group_create: {
            action: "group_create",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createGradingGroup", {
                name: args.name,
        ...
        group_delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deleteGradingGroup", { name: args.name })),
        },
        group_volume: {
            action: "group_volume",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getGradingGroupVolume", { name: args.name })),
        },
        group_surface_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSurfaceFromGradingGroup", {
                name: args.name,
        ...
        list: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listGradings", { groupName: args.groupName })),
        },
        get: {
            action: "get",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getGrading", {
        ...
        create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createGrading", {
                groupName: args.groupName,
        ...
        delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deleteGrading", {
                groupName: args.groupName,
                handle: args.handle,
            })),
        },
        criteria_list: {
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listGradingCriteria", {})),
        },
        feature_line_list: {
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listFeatureLines", {})),
        },
        feature_line_get: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getFeatureLine", { name: args.name })),
        },
        feature_line_export_as_polyline: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("exportFeatureLineAsPolyline", {
                name: args.name,
        ...
        feature_line_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createFeatureLine", {
                points: args.points,
                name: args.name ?? null,
                layer: args.layer ?? "0",
            })),
    ...
    exposures: [
        {
            ...
            description: "放坡聚合工具：查询/读取/创建/删除放坡",
        ...
        },
        {
            ...
            description: "特征线聚合工具：查询/读取/创建特征线",
            inputShape: {
