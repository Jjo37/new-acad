...
export const PARCEL_DOMAIN_DEFINITION = {
    domain: "parcel",
    actions: {
        list_sites: {
            action: "list_sites",
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listParcelSites", {})),
        },
        list: {
            action: "list",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listParcels", { siteName: args.siteName })),
        },
        get: {
            action: "get",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getParcel", {
        ...
        create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createParcel", {
                siteName: args.siteName,
                name: args.name ?? null,
        ...
        edit: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("editParcel", {
                siteName: args.siteName,
                parcelName: args.parcelName,
        ...
        lot_line_adjust: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("adjustParcelLotLine", {
                siteName: args.siteName,
                parcelName: args.parcelName,
        ...
        report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("reportParcels", {
                siteName: args.siteName,
