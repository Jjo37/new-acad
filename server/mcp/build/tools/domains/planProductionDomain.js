...
export const PLAN_PRODUCTION_DOMAIN_DEFINITION = {
    ...
    actions: {
        sheet_set_list: {
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSheetSets", {})),
        },
        sheet_set_get_info: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSheetSetInfo", { name: args.name })),
        },
        sheet_set_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSheetSet", {
                name: args.name,
        ...
        sheet_add: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("addSheet", {
        ...
        sheet_get_properties: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSheetProperties", {
                sheetSetName: args.sheetSetName,
                sheetName: args.sheetName,
            })),
        },
        sheet_set_title_block: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("setSheetTitleBlock", {
                sheetSetName: args.sheetSetName,
                sheetName: args.sheetName,
        ...
        plan_profile_sheet_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createPlanProfileSheet", {
                sheetSetName: args.sheetSetName,
        ...
        plan_profile_sheet_update_alignment: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("updatePlanProfileSheetAlignment", {
                sheetSetName: args.sheetSetName,
                sheetName: args.sheetName,
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        sheet_view_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSheetView", {
                layoutName: args.layoutName,
        ...
        sheet_view_set_scale: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("setSheetViewScale", {
                layoutName: args.layoutName,
        ...
        sheet_publish_pdf: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("publishSheetPdf", {
        ...
        sheet_set_export: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("exportSheetSet", {
                sheetSetName: args.sheetSetName,
                outputPath: args.outputPath,
                overwrite: args.overwrite ?? false,
                plotStyleTable: args.plotStyleTable,
