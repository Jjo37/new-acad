...
export const POINT_DOMAIN_DEFINITION = {
    domain: "point",
    actions: {
        list: {
            action: "list",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listCogoPoints", {
        ...
        get: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getCogoPoint", {
        ...
        create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createCogoPoints", {
                points: args.points,
        ...
        list_groups: {
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listPointGroups", {})),
        },
        import: {
            action: "import",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("importCogoPoints", {
                format: args.format,
                data: args.data,
        ...
        delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deleteCogoPoints", {
        ...
        group_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createPointGroup", {
                name: args.name,
        ...
        group_update: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("updatePointGroup", {
                name: args.name,
        ...
        group_delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deletePointGroup", {
                name: args.name,
            })),
        },
        export: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("exportCogoPoints", {
        ...
        transform: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("transformCogoPoints", {
                pointNumbers: args.pointNumbers ?? null,
                groupName: args.groupName ?? null,
    ...
    exposures: [
        {
            ...
            description: "Cogo 点聚合工具：查询/创建/编辑/导入导出",
        ...
        {
            toolName: "civil3d_create_cogo_point",
            displayName: "Create COGO Point",
            description: "创建 Cogo 点 {points:[{x,y,z,pointNumber?}]}",
            inputShape: {
                easting: z.number(),
                northing: z.number(),
                elevation: z.number().optional(),
        ...
        },
        {
            ...
            description: "导出 Cogo 点 {format: csv/pnezd/penz/xyzd/xyz, groupName?|pointNumbers?}——返回数据字符串",
            inputShape: {
                format: z.enum(["pnezd", "penz", "xyzd", "xyz", "csv"]).optional(),
                groupName: z.string().optional(),
                pointNumbers: z.array(z.number().int().positive()).optional(),
