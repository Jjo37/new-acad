...
// ─── Report helper ────────────────────────────────────────────────────────────
function estimateSampleCount(startStation, endStation, interval) {
    const length = Math.max(0, endStation - startStation);
    return Math.floor(length / interval) + 2;
}
// ─── Domain definition ────────────────────────────────────────────────────────
export const PROFILE_DOMAIN_DEFINITION = {
    domain: "profile",
    actions: {
        list: {
            action: "list",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listProfiles", {
        ...
        get: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getProfile", {
                alignmentName: args.alignmentName,
        ...
        get_elevation: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getProfileElevation", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        sample_elevations: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("sampleProfileElevations", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        create_from_surface: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createProfileFromSurface", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        create_layout: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createLayoutProfile", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
                style: args.style,
                layer: args.layer,
        ...
        delete: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("deleteProfile", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
            })),
        },
        report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => {
                const profile = ProfileDetailResponseSchema.parse(await appClient.sendCommand("getProfile", {
                    alignmentName: args.alignmentName,
                    profileName: args.profileName,
                }));
                ...
                if (sampleCount > maximumSamples) {
                    throw new Error(`Profile report would require ${sampleCount} samples, which exceeds the maximum of ${maximumSamples}. ` +
                        "Increase the interval or maximumSamples.");
                }
                const samples = ProfileSampleElevationsResponseSchema.parse(await appClient.sendCommand("sampleProfileElevations", {
                    alignmentName: args.alignmentName,
                    profileName: args.profileName,
                    startStation,
                    endStation,
        ...
        add_pvi: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileAddPvi", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
                station: args.station,
        ...
        delete_pvi: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileDeletePvi", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
                station: args.station,
            })),
        ...
        add_curve: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileAddCurve", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        set_grade: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileSetGrade", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        check_k_values: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileCheckKValues", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
        ...
        view_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileViewCreate", {
                alignmentName: args.alignmentName,
        ...
        view_band_set: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("profileViewBandSet", {
                profileViewName: args.profileViewName,
        ...
        set_style: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("setProfileStyle", {
                alignmentName: args.alignmentName,
                profileName: args.profileName,
                style: args.style,
            })),
        ...
        set_view_style: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("setProfileViewStyle", {
                profileViewName: args.profileViewName,
