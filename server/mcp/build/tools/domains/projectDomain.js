...
export const PROJECT_DOMAIN_DEFINITION = {
    domain: "project",
    actions: {
        data_shortcut_list: {
            ...
            execute: async () => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listDataShortcuts", {})),
        },
        data_shortcut_create: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createDataShortcut", {
        ...
        data_shortcut_promote: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("promoteDataShortcut", {
        ...
        data_shortcut_reference: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("referenceDataShortcut", {
        ...
        data_shortcut_sync: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("syncDataShortcuts", {
                projectFolder: args.projectFolder ?? null,
        ...
        data_shortcut_create_reference: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createDataShortcutReference", {
    ...
    exposures: [
        {
            ...
            description: "项目聚合工具：数据快捷方式/项目上下文",
        ...
        },
        {
            ...
            description: "数据快捷方式聚合工具：创建/引用/同步/提升",
            inputShape: {
