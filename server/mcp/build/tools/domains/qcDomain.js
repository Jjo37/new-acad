...
export const QC_DOMAIN_DEFINITION = {
    domain: "qc",
    actions: {
        check_alignment: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckAlignment", {
                name: args.name,
        ...
        check_profile: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckProfile", {
        ...
        check_corridor: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckCorridor", { name: args.name })),
        },
        check_pipe_network: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckPipeNetwork", {
                name: args.name,
        ...
        check_surface: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckSurface", {
                name: args.name,
        ...
        generate_report: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcReportGenerate", {
