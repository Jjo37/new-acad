...
// ─── Domain definition ────────────────────────────────────────────────────────
export const SECTION_DOMAIN_DEFINITION = {
    domain: "section",
    actions: {
        list_sample_lines: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSampleLineGroups", {
        ...
        get_section_data: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getSectionData", {
                alignmentName: args.alignmentName,
        ...
        create_sample_lines: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("createSampleLines", {
                alignmentName: args.alignmentName,
        ...
        view_list: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listSectionViews", {
        ...
        view_update_style: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("updateSectionViewStyles", {
                alignmentName: args.alignmentName,
                sampleLineGroupName: args.sampleLineGroupName,
                style: args.style ?? null,
                bandSetStyle: args.bandSetStyle ?? null,
        ...
        view_export: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("exportSectionData", {
                alignmentName: args.alignmentName,
                sampleLineGroupName: args.sampleLineGroupName,
