...
export const STANDARDS_DOMAIN_DEFINITION = {
    domain: "standards",
    actions: {
        label_list: {
            action: "label_list",
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listLabels", {
        ...
        label_add: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("addLabel", {
                objectType: args.objectType,
                objectName: args.objectName,
        ...
        label_list_styles: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listLabelStyles", {
                objectType: args.objectType,
            })),
        },
        style_list: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("listStyles", {
                objectType: args.objectType,
            })),
        },
        style_get: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("getStyle", {
                objectType: args.objectType,
        ...
        check_labels: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckLabels", {
        ...
        check_drawing_standards: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcCheckDrawingStandards", {
        ...
        fix_drawing_standards: {
            ...
            execute: async (args) => await withApplicationConnection(async (appClient) => await appClient.sendCommand("qcFixDrawingStandards", {
                layerPrefix: args.layerPrefix ?? null,
    ...
    exposures: [
        {
            ...
            description: "标准聚合工具：标签/样式/标准查询与修复",
